...
def fsl_imbalanced(g_args, models=[], strategies=[], seeds=[], train_tasks=[], test_tasks=[], var_update={}, save=True, 
    ...
    is_baseline = lambda x: x in ['baseline', 'baselinepp']
        ...
        for model in models:
            for train_task in train_tasks:
                ...
                for strategy in strategies:
                    ...
                    elif model in ['baseline', 'baselinepp']:
...
if __name__ == '__main__':
    ...
    if g_args.load_backbone:
        ...
        backbone = "/mnt/batch/tasks/shared/LS_root/mountrs/Users/gako/imbalanceresd_fsl_public/experiments/imbalanced_task/mini/Conv4/"+\
