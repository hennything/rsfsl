...
from backbones.resnet import ResNet10, ResNet18, ResNet34
...
DATASETS = {
    ...
    "aid"        : get_Aid,
    "ucmerced"   : get_Ucm,
    "patternnet" : get_Patternnet,
    "resisc45"   : get_Resisc45,
    "resisc45_to_ucm": get_Resisc45_to_Ucm,
    "resisc45_to_aid": get_Resisc45_to_Aid,
    "resisc45_to_whurs19": get_Resisc45_to_Whurs19,
    "resisc45_to_patternnet": get_Resisc45_to_Patternnet,
    "ucm_to_resisc45": get_Ucm_to_Resisc45,
    "ucm_to_aid": get_Ucm_to_Aid,
    "ucm_to_whurs19": get_Ucm_to_Whurs19,
    "ucm_to_patternnet": get_Ucm_to_Patternnet,
    "aid_to_resisc45": get_Aid_to_Resisc45,
    "aid_to_ucm": get_Aid_to_Ucm,
    "aid_to_whurs19": get_Aid_to_Whurs19,
    "aid_to_patternnet": get_Aid_to_Patternnet,
    "whurs19_to_resisc45": get_Whurs19_to_Resisc45,
    "whurs19_to_ucm": get_Whurs19_to_Ucm,
    "whurs19_to_aid": get_Whurs19_to_Aid,
    "whurs19_to_patternnet": get_Whurs19_to_Patternnet,
    "patternnet_to_resisc45": get_Patternnet_to_Resisc45,
    "patternnet_to_ucm": get_Patternnet_to_Ucm,
    "patternnet_to_aid": get_Patternnet_to_Aid,
    "patternnet_to_whurs19": get_Patternnet_to_Whurs19
...
def get_task_classes(task_name, model_name):
    ...
    if model_name in ["baseline", "baselinepp"]:
...
def get_model(backbone, tasks, datasets, stategy, args, device):
    ...
    if args.model in ["baseline", "baselinepp", "maml", "protomaml"]:
        output_dims = dict()
