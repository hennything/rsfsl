...
def get_Resisc45(args_per_set, setnames=["train", "val", "test"]):
    """
    Returns resisc45 datasets.
    """
    datasets = {}
    for setname in setnames:
        args = args_per_set[setname]
        data_path = os.path.abspath(args.data_path)
        filepath = os.path.join(data_path, "resisc45", "resisc45-cache-{0}.pkl".format(setname))
